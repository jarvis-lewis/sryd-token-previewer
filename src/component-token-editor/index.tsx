...
import { Anchor, ConfigProvider, Empty, Menu, Switch, Tooltip } from 'sryd';
import tokenMeta from 'sryd/lib/version/token-meta.json';
import tokenStatistic from 'sryd/lib/version/token.json';
